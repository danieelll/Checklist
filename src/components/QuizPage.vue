<template>
    <div id="app" class="quiz-bg mx-auto pt-5 m-0">
        ...
        <!--<div class="container quiz-img p-0 mt-5 mb-5">
            <img class="d-inline" src="../assets/img/icon-img/quiz-brain-gear.png">
        </div>-->
                        ...
                        <div v-show="currentSet == 4" class="row justify-content-center mt-4">
                            <div class="col mx-auto text-center">
                                <form class="opt-in mt-3 mx-auto" ref="form" @submit="redirect">
                                    <p>Enter Your <span class="fw-bold">Email & Name</span> To See Your Result!</p>
                                    <input class="form-control mt-2" type="text" name="name" v-model="name" placeholder="Name" required>
                                    <input class="form-control mt-2" type="mail" name="mail" v-model="mail" placeholder="Email" required>
                                    <!--<a class="btn d-black my-4 text-light shade-submit" v-on:click="redirect">See My Result></a>-->
                                    <button type="submit"  class="btn d-black my-4 text-light shade-submit">See My Result</button>
                                </form>
                                
                                <!--<button class="btn btn-next d-black my-4 d-none" @click="redirect">
                                    Reveal
                                </button>-->
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            redirect: function(e) {
                e.preventDefault();
                window.location.href = "https://wealthavatarr.com/redirect?avatar=" + this.avatar + "&name=" + this.name + "&mail=" + this.mail;
            },
